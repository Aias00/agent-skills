...
from cdp_publish import (
    XiaohongshuPublisher,
    CDPError,
    normalize_image_text_title,
    XHS_IMAGE_TEXT_TITLE_LIMIT,
)
...
def main():
    ...
    if args.mode == "image-text":
        ...
        if normalized_title != title:
            print(
                f"[pipeline] Image-text title exceeded {XHS_IMAGE_TEXT_TITLE_LIMIT} chars. "
                f"Normalized to: {normalized_title}"
            )
