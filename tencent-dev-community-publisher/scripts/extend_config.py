#!/usr/bin/env python3
"""
Load optional EXTEND.md preferences for tencent-dev-community-publisher.

Priority:
1) Project-level: <cwd>/.baoyu-skills/tencent-dev-community-publisher/EXTEND.md
...
PROJECT_EXTEND = Path(".baoyu-skills/tencent-dev-community-publisher/EXTEND.md")
USER_EXTEND = Path.home() / ".baoyu-skills/tencent-dev-community-publisher/EXTEND.md"
